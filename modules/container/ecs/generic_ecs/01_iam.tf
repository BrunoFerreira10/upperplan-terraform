...
resource "aws_iam_policy" "ecs_task_execution" {
  name        = "${var.env}_ECSTaskExecution_${var.shortname}_${var.region}"
...
resource "aws_iam_policy" "ecs_task" {
  name        = "${var.env}_ECSTask_${var.shortname}_${var.region}"
...
resource "aws_iam_policy" "ecs_s3_access" {
  name = "${var.env}_ECSS3Access_${var.shortname}_${var.region}"
