...
resource "aws_iam_policy" "connections" {
  name        = "${var.env}_GetConnection_${var.shortname}_${var.project_name}_${var.region}"
...
resource "aws_iam_policy" "ecr_get_and_push" {
  name        = "${var.env}_ECRPush_${var.shortname}-${var.project_name}-${var.region}"
  path        = "/TerraformManaged/"
  ...
  tags = {
    Name = "${var.env}_ECRPush_${var.shortname}_${var.project_name}_${var.region}"
  }
}

resource "aws_iam_policy" "start_build" {
  name        = "${var.env}_StartBuild_${var.shortname}_${var.project_name}_${var.region}"
...
resource "aws_iam_policy" "ssm_read" {
  name        = "${var.env}_SSMRead_${var.shortname}_${var.project_name}_${var.region}"
...
resource "aws_iam_role" "codebuild" {
  name = "${var.env}_CodeBuild_${var.shortname}_${var.project_name}_${var.region}"
