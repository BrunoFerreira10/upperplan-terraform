...
phases:
  ...
  build:
    commands:
      ...
      - export SSM_HOST="/${ENV}/upperplan_glpi/app_vars/rds_1_db_host"
      - export SSM_NAME="/upperplan_glpi/prod/github_vars/rds_1_db_name"
      - export SSM_USER="/upperplan_glpi/prod/github_vars/rds_1_db_username"
      - export SSM_PASSWORD="/upperplan_glpi/prod/github_secrets/rds_1_db_password"
  ...
  post_build:
    commands:
      ...
      - mkdir -p app-build
      - ls -la
      - cp appspec_${ENV}.yml app-build/appspec.yml
artifacts:
  files:
    - "**/*"
  discard-paths: no
