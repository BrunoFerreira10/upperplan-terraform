...
inputs = {
  param_name  = "/${local.github_vars_mock.values.general_tag_shortname}/prod/app_vars/ses-user/secret-access-key"
  param_value = dependency.ses.outputs.ses_user_secret_access_key
}